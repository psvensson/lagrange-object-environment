...
- [System Inspector](architecture/system-inspector.md) — live cluster topology, placement, load, coordinated views and the control-plane observation boundary
...
- [Live system inspection](decisions/0017-live-system-inspection.md) — System Inspector is an ordinary Perspective over transient public control-plane observations; live cluster state is never mirrored into image objects
