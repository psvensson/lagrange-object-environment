...
export class Surface {
  ...
  onPointerUp(): AsyncIterable<PointerEvent>;
  onPointerDown(): AsyncIterable<PointerEvent>;
  onPointerMove(): AsyncIterable<PointerEvent>;
  onKeyUp(): AsyncIterable<KeyEvent>;
  onKeyDown(): AsyncIterable<KeyEvent>;
}
