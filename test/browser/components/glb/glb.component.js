...
class StreamWritableEnd extends StreamEnd {
  ...
  const module0 = getCoreModule('glb.component.core.wasm');
  const module1 = getCoreModule('glb.component.core2.wasm');
  const module2 = getCoreModule('glb.component.core3.wasm');
  
  const { load } = imports['lagrange-assets'];
  
  if (load=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'load', was 'load' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  const print = imports['lagrange-print'].default;
  const { Surface } = imports['lagrange-surface'];
  
  if (Surface=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'Surface', was 'Surface' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  const { Context } = imports['lagrange-surface-webgpu'];
  
  if (Context=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'Context', was 'Context' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  const { Gpu, GpuAdapter, GpuBindGroup, GpuBindGroupLayout, GpuBuffer, GpuCommandBuffer, GpuCommandEncoder, GpuDevice, GpuPipelineLayout, GpuQuerySet, GpuQueue, GpuRenderPassEncoder, GpuRenderPipeline, GpuSampler, GpuShaderModule, GpuTexture, GpuTextureView, RecordGpuPipelineConstantValue, RecordOptionGpuSize64, getGpu } = imports['lagrange-webgpu'];
  
  if (Gpu=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'Gpu', was 'Gpu' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuAdapter=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuAdapter', was 'GpuAdapter' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  if (GpuBindGroup=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuBindGroup', was 'GpuBindGroup' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuBindGroupLayout=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuBindGroupLayout', was 'GpuBindGroupLayout' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  if (GpuBuffer=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuBuffer', was 'GpuBuffer' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuCommandBuffer=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuCommandBuffer', was 'GpuCommandBuffer' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  if (GpuCommandEncoder=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuCommandEncoder', was 'GpuCommandEncoder' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  if (GpuDevice=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuDevice', was 'GpuDevice' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuPipelineLayout=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuPipelineLayout', was 'GpuPipelineLayout' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuQuerySet=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuQuerySet', was 'GpuQuerySet' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  if (GpuQueue=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuQueue', was 'GpuQueue' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuRenderPassEncoder=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuRenderPassEncoder', was 'GpuRenderPassEncoder' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuRenderPipeline=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuRenderPipeline', was 'GpuRenderPipeline' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  if (GpuSampler=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuSampler', was 'GpuSampler' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuShaderModule=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuShaderModule', was 'GpuShaderModule' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  if (GpuTexture=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuTexture', was 'GpuTexture' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (GpuTextureView=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'GpuTextureView', was 'GpuTextureView' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (RecordGpuPipelineConstantValue=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'RecordGpuPipelineConstantValue', was 'RecordGpuPipelineConstantValue' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  
  
  if (RecordOptionGpuSize64=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'RecordOptionGpuSize64', was 'RecordOptionGpuSize64' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  if (getGpu=== undefined) {
    const err = new Error("unexpectedly undefined instance import 'getGpu', was 'getGpu' available at instantiation?");
    console.error("ERROR:", err.toString());
    throw err;
  }
  ...
  let gen = (function* _initGenerator () {
    ...
    const _trampoline6 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
      ...
      if (!rsc3) {
        rsc3 = Object.create(GpuBuffer.prototype);
        Object.defineProperty(rsc3, symbolRscHandle, { writable: true, value: handle4});
        Object.defineProperty(rsc3, symbolRscRep, { writable: true, value: rep5});
      }
      ...
      switch (arg3) {
        ...
        case 1: {
          variant7 = BigInt.asUintN(64, BigInt(arg4));
          break;
        }
        default: {
      ...
      switch (arg5) {
        ...
        case 1: {
          variant8 = BigInt.asUintN(64, BigInt(arg6));
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-render-pass-encoder.set-index-buffer"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      try {
        _withGlobalCurrentTaskMeta({
          componentIdx: task.componentIdx(),
          taskID: task.id(),
          fn: () => rsc0.setIndexBuffer(rsc3, enum6, variant7, variant8),
        })
        ;
      } catch (err) {
      ...
      curResourceBorrows = [];
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-render-pass-encoder.set-index-buffer"][Instruction::Return]', {
        funcName: '[method]gpu-render-pass-encoder.set-index-buffer',
        paramCount: 0,
        async: false,
        postReturn: false
      });
    ...
    _trampoline6.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#setIndexBuffer';
    
    const _trampoline7 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
      var handle1 = arg0;
      ...
      switch (arg4) {
        ...
        case 1: {
          variant7 = BigInt.asUintN(64, BigInt(arg5));
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (arg6) {
        ...
        case 1: {
          variant8 = BigInt.asUintN(64, BigInt(arg7));
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-render-pass-encoder.set-vertex-buffer"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      try {
        _withGlobalCurrentTaskMeta({
          componentIdx: task.componentIdx(),
          taskID: task.id(),
          fn: () => rsc0.setVertexBuffer(arg1 >>> 0, variant6, variant7, variant8),
        })
        ;
      } catch (err) {
      ...
      curResourceBorrows = [];
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-render-pass-encoder.set-vertex-buffer"][Instruction::Return]', {
        funcName: '[method]gpu-render-pass-encoder.set-vertex-buffer',
        paramCount: 0,
        async: false,
        postReturn: false
      });
    ...
    _trampoline7.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#setVertexBuffer';
    ...
    const _trampoline8 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-render-pass-encoder.draw-indexed"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      try {
        _withGlobalCurrentTaskMeta({
          componentIdx: task.componentIdx(),
          taskID: task.id(),
          fn: () => rsc0.drawIndexed(arg1 >>> 0, variant3, variant4, variant5, variant6),
        })
        ;
      } catch (err) {
      ...
      curResourceBorrows = [];
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-render-pass-encoder.draw-indexed"][Instruction::Return]', {
        funcName: '[method]gpu-render-pass-encoder.draw-indexed',
        paramCount: 0,
        async: false,
        postReturn: false
      });
    ...
    _trampoline8.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#drawIndexed';
    ...
    _trampoline9.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#getGpu';
    
    const handleTable19 = [T_FLAG, 0];
    handleTable19._createdReps = new Set();
    
    
    const captureTable19= new Map();
    let captureCnt19= 0;
    
    HANDLE_TABLES[19] = handleTable19;
    ...
    _trampoline19.fnName = 'wasi-gfx:surface/surface@0.2.0#new Surface';
    
    const handleTable20 = [T_FLAG, 0];
    handleTable20._createdReps = new Set();
    
    
    const captureTable20= new Map();
    let captureCnt20= 0;
    
    HANDLE_TABLES[20] = handleTable20;
    ...
    const _trampoline20 = function(arg0) {
      ...
      var handle3 = ret[symbolRscHandle];
      if (!handle3) {
        const rep = ret[symbolRscRep] || ++captureCnt20;
        captureTable20.set(rep, ret);
    ...
    _trampoline20.fnName = 'wasi-gfx:surface/surface-webgpu@0.2.0#new Context';
    ...
    const _trampoline21 = function(arg0) {
      ...
      curResourceBorrows.push(rsc0);
      _debugLog('[iface="wasi-gfx:surface/surface@0.2.0", function="[method]surface.width"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      curResourceBorrows = [];
      _debugLog('[iface="wasi-gfx:surface/surface@0.2.0", function="[method]surface.width"][Instruction::Return]', {
        funcName: '[method]surface.width',
        paramCount: 1,
        async: false,
        postReturn: false
      });
    ...
    _trampoline21.fnName = 'wasi-gfx:surface/surface@0.2.0#width';
    ...
    const _trampoline22 = function(arg0) {
      ...
      curResourceBorrows.push(rsc0);
      _debugLog('[iface="wasi-gfx:surface/surface@0.2.0", function="[method]surface.height"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      curResourceBorrows = [];
      _debugLog('[iface="wasi-gfx:surface/surface@0.2.0", function="[method]surface.height"][Instruction::Return]', {
        funcName: '[method]surface.height',
        paramCount: 1,
        async: false,
        postReturn: false
      });
    ...
    _trampoline22.fnName = 'wasi-gfx:surface/surface@0.2.0#height';
    ...
    const _trampoline27 = function(arg0) {
      ...
      const { writeEnd: hostWriteEnd3, readEnd: readEnd3 } = createStream(cstate3, {
        ...
        elemMeta: {
          ...
          payloadTypeName: 'Record(TypeRecordIndex(43))',
          isNone: false,
          isNumeric: false,
          isBorrowed: false,
          isAsyncValue: false,
    ...
    _trampoline27.fnName = 'wasi-gfx:surface/surface@0.2.0#onFrame';
    ...
    const _trampoline28 = function(arg0) {
      ...
      const { writeEnd: hostWriteEnd3, readEnd: readEnd3 } = createStream(cstate3, {
        ...
        elemMeta: {
          ...
          payloadTypeName: 'Record(TypeRecordIndex(44))',
          isNone: false,
          isNumeric: false,
          isBorrowed: false,
          isAsyncValue: false,
    ...
    _trampoline28.fnName = 'wasi-gfx:surface/surface@0.2.0#onResize';
    ...
    const _trampoline31 = function(arg0) {
      ...
      var rsc0 = captureTable20.get(rep2);
      if (!rsc0) {
    ...
    _trampoline31.fnName = 'wasi-gfx:surface/surface-webgpu@0.2.0#getCurrentTexture';
    ...
    _trampoline35.fnName = 'wasi-gfx:surface/surface-webgpu@0.2.0#present';
    let exports1;
    let memory0;
    let realloc0;
    let realloc0Async;
    ...
    const _trampoline52 = async function(arg0, arg1) {
    ...
    _trampoline52.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#requestAdapter';
    ...
    _trampoline53.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#requestDevice';
    ...
    const _trampoline54 = function(arg0, arg1) {
      ...
      if (!rsc0) {
        rsc0 = Object.create(GpuBuffer.prototype);
        Object.defineProperty(rsc0, symbolRscHandle, { writable: true, value: handle1});
        Object.defineProperty(rsc0, symbolRscRep, { writable: true, value: rep2});
      }
      
      curResourceBorrows.push(rsc0);
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-buffer.unmap"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      switch (variant7.tag) {
        ...
        case 'err': {
          ...
          switch (variant5.tag) {
            ...
            default: {
              throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant5.tag)}\` (received \`${variant5}\`) specified for \`UnmapErrorKind\``);
            }
          }
          ...
          dataView(memory0).setUint32(arg1 + 12, len6, true);
          dataView(memory0).setUint32(arg1 + 8, ptr6, true);
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-buffer.unmap"][Instruction::Return]', {
        funcName: '[method]gpu-buffer.unmap',
        paramCount: 0,
        async: false,
        postReturn: false
      });
    ...
    _trampoline54.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#unmap';
    
    const _trampoline55 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
      var handle1 = arg0;
      ...
      switch (arg3) {
        ...
        case 1: {
          variant4 = BigInt.asUintN(64, BigInt(arg4));
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (arg5) {
        ...
        case 1: {
          variant5 = BigInt.asUintN(64, BigInt(arg6));
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-buffer.get-mapped-range-set-with-copy"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      const createTask = () => {
        const results = createNewCurrentTask({
          componentIdx: -1,
          isAsync: false,
          entryFnName: 'getMappedRangeSetWithCopy',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'result-catch-handler',
          callingWasmExport: false,
      ...
      try {
        const hostRet6 = _withGlobalCurrentTaskMeta({
          componentIdx: task.componentIdx(),
          taskID: task.id(),
          fn: () => rsc0.getMappedRangeSetWithCopy(result3, variant4, variant5),
        })
        ;
      ...
      switch (variant10.tag) {
        ...
        case 'err': {
          ...
          switch (variant8.tag) {
            ...
            default: {
              throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant8.tag)}\` (received \`${variant8}\`) specified for \`GetMappedRangeErrorKind\``);
            }
          }
          ...
          dataView(memory0).setUint32(arg7 + 12, len9, true);
          dataView(memory0).setUint32(arg7 + 8, ptr9, true);
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-buffer.get-mapped-range-set-with-copy"][Instruction::Return]', {
        funcName: '[method]gpu-buffer.get-mapped-range-set-with-copy',
        paramCount: 0,
        async: false,
        postReturn: false
      });
    ...
    _trampoline55.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#getMappedRangeSetWithCopy';
    ...
    const _trampoline56 = function(arg0) {
          ...
          case 1: {
            ...
            switch (dataView(memory0).getUint8(base + 20, true)) {
              ...
              case 1: {
                ...
                var rep9 = handleTable6[(handle8 << 1) + 1] & ~T_FLAG;
                var rsc7 = captureTable6.get(rep9);
                if (!rsc7) {
      ...
      switch (dataView(memory0).getUint8(arg0 + 16, true)) {
        ...
        case 1: {
          ...
          var rep18 = handleTable6[(handle17 << 1) + 1] & ~T_FLAG;
          var rsc16 = captureTable6.get(rep18);
          if (!rsc16) {
      ...
      switch (dataView(memory0).getUint8(arg0 + 56, true)) {
        ...
        case 1: {
          ...
          var rep36 = handleTable7[(handle35 << 1) + 1] & ~T_FLAG;
          var rsc34 = captureTable7.get(rep36);
          if (!rsc34) {
      ...
      switch (dataView(memory0).getUint8(arg0 + 64, true)) {
        ...
        case 1: {
          ...
          var rep40 = handleTable7[(handle39 << 1) + 1] & ~T_FLAG;
          var rsc38 = captureTable7.get(rep40);
          if (!rsc38) {
      ...
      if (!handle47) {
        ...
        handle47 = rscTableCreateOwn(handleTable8, rep);
      }
    ...
    _trampoline56.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#beginRenderPass';
    ...
    const _trampoline57 = function(arg0, arg1, arg2, arg3, arg4) {
      var handle1 = arg0;
    ...
    _trampoline57.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#finish';
    
    const _trampoline58 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
      var handle1 = arg0;
      ...
      curResourceBorrows.push(rsc0);
      if ((arg2 & 4294966272) !== 0) {
        throw new TypeError('flags have extraneous bits set');
      }
      var flags3 = {
        mapRead: Boolean(arg2 & 1),
        mapWrite: Boolean(arg2 & 2),
        copySrc: Boolean(arg2 & 4),
        copyDst: Boolean(arg2 & 8),
        index: Boolean(arg2 & 16),
        vertex: Boolean(arg2 & 32),
        uniform: Boolean(arg2 & 64),
        storage: Boolean(arg2 & 128),
        indirect: Boolean(arg2 & 256),
        queryResolve: Boolean(arg2 & 512),
      };
      let variant5;
      switch (arg3) {
        case 0: {
        ...
        case 1: {
          var bool4 = arg4;
          variant5 = bool4 == 0 ? false : (bool4 == 1 ? true : throwInvalidBool());
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-device.create-buffer"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      try {
        ret = _withGlobalCurrentTaskMeta({
          componentIdx: task.componentIdx(),
          taskID: task.id(),
          fn: () => rsc0.createBuffer({
            size: BigInt.asUintN(64, BigInt(arg1)),
            usage: flags3,
            mappedAtCreation: variant5,
            label: variant7,
          }),
        })
        ;
      ...
      if (!(ret instanceof GpuBuffer)) {
        throw new TypeError('Resource error: Not a valid \"GpuBuffer\" resource.');
      }
      var handle8 = ret[symbolRscHandle];
      if (!handle8) {
        const rep = ret[symbolRscRep] || ++captureCnt4;
        captureTable4.set(rep, ret);
        handle8 = rscTableCreateOwn(handleTable4, rep);
      }
      
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-device.create-buffer"][Instruction::Return]', {
        funcName: '[method]gpu-device.create-buffer',
        paramCount: 1,
        async: false,
        postReturn: false
      });
      task.resolve([handle8]);
      task.exit();
      return handle8;
    }
    _trampoline58.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#createBuffer';
    ...
    const _trampoline59 = function(arg0) {
      ...
      switch (dataView(memory0).getUint8(arg0 + 8, true)) {
        ...
        case 1: {
          variant3 = dataView(memory0).getInt32(arg0 + 12, true) >>> 0;
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (dataView(memory0).getUint8(arg0 + 16, true)) {
        ...
        case 1: {
          variant4 = dataView(memory0).getInt32(arg0 + 20, true) >>> 0;
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (dataView(memory0).getUint8(arg0 + 24, true)) {
        ...
        case 1: {
          variant5 = dataView(memory0).getInt32(arg0 + 28, true) >>> 0;
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (dataView(memory0).getUint8(arg0 + 32, true)) {
        ...
        case 1: {
          variant6 = dataView(memory0).getInt32(arg0 + 36, true) >>> 0;
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (dataView(memory0).getUint8(arg0 + 40, true)) {
        ...
        case 1: {
          ...
          switch (dataView(memory0).getUint8(arg0 + 41, true)) {
            ...
            default: {
              throw new TypeError('invalid discriminant specified for GpuTextureDimension');
            }
          }
          variant8 = enum7;
          break;
      ...
      if ((dataView(memory0).getUint8(arg0 + 43, true) & 4294967232) !== 0) {
        throw new TypeError('flags have extraneous bits set');
      }
      var flags10 = {
        copySrc: Boolean(dataView(memory0).getUint8(arg0 + 43, true) & 1),
        copyDst: Boolean(dataView(memory0).getUint8(arg0 + 43, true) & 2),
        textureBinding: Boolean(dataView(memory0).getUint8(arg0 + 43, true) & 4),
        storageBinding: Boolean(dataView(memory0).getUint8(arg0 + 43, true) & 8),
        renderAttachment: Boolean(dataView(memory0).getUint8(arg0 + 43, true) & 16),
        transientAttachment: Boolean(dataView(memory0).getUint8(arg0 + 43, true) & 32),
      };
      let variant13;
      switch (dataView(memory0).getUint8(arg0 + 44, true)) {
        case 0: {
        ...
        case 1: {
          var len12 = dataView(memory0).getUint32(arg0 + 52, true);
          var base12 = dataView(memory0).getUint32(arg0 + 48, true);
          if (base12 % 1 !== 0) throw new TypeError(`list pointer [${base12}] is not aligned to 1`);
          var result12 = [];
          for (let i = 0; i < len12; i++) {
            ...
            switch (dataView(memory0).getUint8(base + 0, true)) {
              ...
              case 48: {
                enum11 = 'depth32float-stencil8';
                break;
              }
              case 49: {
                enum11 = 'bc1-rgba-unorm';
                break;
              }
              case 50: {
                enum11 = 'bc1-rgba-unorm-srgb';
                break;
              }
              case 51: {
                enum11 = 'bc2-rgba-unorm';
                break;
              }
              case 52: {
                enum11 = 'bc2-rgba-unorm-srgb';
                break;
              }
              case 53: {
                enum11 = 'bc3-rgba-unorm';
                break;
              }
              case 54: {
                enum11 = 'bc3-rgba-unorm-srgb';
                break;
              }
              case 55: {
                enum11 = 'bc4-r-unorm';
              ...
              case 59: {
                enum11 = 'bc6h-rgb-ufloat';
                break;
              }
              case 60: {
                enum11 = 'bc6h-rgb-float';
                break;
              }
              case 61: {
                enum11 = 'bc7-rgba-unorm';
                break;
              }
              case 62: {
                enum11 = 'bc7-rgba-unorm-srgb';
                break;
              }
              case 63: {
                enum11 = 'etc2-rgb8unorm';
                break;
              }
              case 64: {
                enum11 = 'etc2-rgb8unorm-srgb';
                break;
              }
              case 65: {
                enum11 = 'etc2-rgb8a1unorm';
                break;
              }
              case 66: {
                enum11 = 'etc2-rgb8a1unorm-srgb';
                break;
              }
              case 67: {
                enum11 = 'etc2-rgba8unorm';
                break;
              }
              case 68: {
                enum11 = 'etc2-rgba8unorm-srgb';
                break;
              }
              case 69: {
                enum11 = 'eac-r11unorm';
              ...
              case 71: {
                enum11 = 'eac-rg11unorm';
                break;
              }
              case 72: {
                enum11 = 'eac-rg11snorm';
                break;
              }
              case 73: {
                enum11 = 'astc4x4-unorm';
                break;
              }
              case 74: {
                enum11 = 'astc4x4-unorm-srgb';
                break;
              }
              case 75: {
                enum11 = 'astc5x4-unorm';
                break;
              }
              case 76: {
                enum11 = 'astc5x4-unorm-srgb';
                break;
              }
              case 77: {
                enum11 = 'astc5x5-unorm';
                break;
              }
              case 78: {
                enum11 = 'astc5x5-unorm-srgb';
                break;
              }
              case 79: {
                enum11 = 'astc6x5-unorm';
                break;
              }
              case 80: {
                enum11 = 'astc6x5-unorm-srgb';
                break;
              }
              case 81: {
                enum11 = 'astc6x6-unorm';
                break;
              }
              case 82: {
                enum11 = 'astc6x6-unorm-srgb';
                break;
              }
              case 83: {
                enum11 = 'astc8x5-unorm';
                break;
              }
              case 84: {
                enum11 = 'astc8x5-unorm-srgb';
                break;
              }
              case 85: {
                enum11 = 'astc8x6-unorm';
                break;
              }
              case 86: {
                enum11 = 'astc8x6-unorm-srgb';
                break;
              }
              case 87: {
                enum11 = 'astc8x8-unorm';
                break;
              }
              case 88: {
                enum11 = 'astc8x8-unorm-srgb';
                break;
              }
              case 89: {
                enum11 = 'astc10x5-unorm';
                break;
              }
              case 90: {
                enum11 = 'astc10x5-unorm-srgb';
                break;
              }
              case 91: {
                enum11 = 'astc10x6-unorm';
                break;
              }
              case 92: {
                enum11 = 'astc10x6-unorm-srgb';
                break;
              }
              case 93: {
                enum11 = 'astc10x8-unorm';
                break;
              }
              case 94: {
                enum11 = 'astc10x8-unorm-srgb';
                break;
              }
              case 95: {
                enum11 = 'astc10x10-unorm';
                break;
              }
              case 96: {
                enum11 = 'astc10x10-unorm-srgb';
                break;
              }
              case 97: {
                enum11 = 'astc12x10-unorm';
                break;
              }
              case 98: {
                enum11 = 'astc12x10-unorm-srgb';
                break;
              }
              case 99: {
                enum11 = 'astc12x12-unorm';
                break;
              }
              case 100: {
                enum11 = 'astc12x12-unorm-srgb';
                break;
              }
              default: {
                throw new TypeError('invalid discriminant specified for GpuTextureFormat');
      ...
      switch (dataView(memory0).getUint8(arg0 + 60, true)) {
        ...
        case 1: {
          var ptr16 = dataView(memory0).getUint32(arg0 + 64, true);
          var len16 = dataView(memory0).getUint32(arg0 + 68, true);
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-device.create-texture"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      try {
        ret = _withGlobalCurrentTaskMeta({
          componentIdx: task.componentIdx(),
          taskID: task.id(),
          fn: () => rsc0.createTexture({
            size: {
              width: dataView(memory0).getInt32(arg0 + 4, true) >>> 0,
              height: variant3,
              depthOrArrayLayers: variant4,
            },
            mipLevelCount: variant5,
            sampleCount: variant6,
            dimension: variant8,
            format: enum9,
            usage: flags10,
            viewFormats: variant13,
            textureBindingViewDimension: variant15,
            label: variant17,
          }),
        })
        ;
      ...
      if (!handle18) {
        const rep = ret[symbolRscRep] || ++captureCnt11;
        captureTable11.set(rep, ret);
        handle18 = rscTableCreateOwn(handleTable11, rep);
      }
      
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-device.create-texture"][Instruction::Return]', {
        funcName: '[method]gpu-device.create-texture',
        paramCount: 1,
        async: false,
        postReturn: false
      });
    ...
    _trampoline59.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#createTexture';
    ...
    const _trampoline60 = function(arg0, arg1, arg2, arg3, arg4, arg5) {
      var handle1 = arg0;
      ...
      var len26 = arg2;
      var base26 = arg1;
      if (base26 % 8 !== 0) throw new TypeError(`list pointer [${base26}] is not aligned to 8`);
      var result26 = [];
      for (let i = 0; i < len26; i++) {
        const base = base26 + i * 56;
        if ((dataView(memory0).getUint8(base + 4, true) & 4294967288) !== 0) {
          throw new TypeError('flags have extraneous bits set');
        }
        var flags3 = {
          vertex: Boolean(dataView(memory0).getUint8(base + 4, true) & 1),
          fragment: Boolean(dataView(memory0).getUint8(base + 4, true) & 2),
          compute: Boolean(dataView(memory0).getUint8(base + 4, true) & 4),
        };
        let variant9;
        switch (dataView(memory0).getUint8(base + 8, true)) {
          ...
          case 1: {
            ...
            switch (dataView(memory0).getUint8(base + 16, true)) {
              ...
              case 1: {
                ...
                switch (dataView(memory0).getUint8(base + 17, true)) {
                  ...
                  case 2: {
                    enum4 = 'read-only-storage';
                    break;
                  }
                  default: {
                    throw new TypeError('invalid discriminant specified for GpuBufferBindingType');
                  }
                }
                variant5 = enum4;
                break;
            ...
            let variant7;
            switch (dataView(memory0).getUint8(base + 18, true)) {
              case 0: {
                variant7 = undefined;
                break;
              }
              case 1: {
                var bool6 = dataView(memory0).getUint8(base + 19, true);
                variant7 = bool6 == 0 ? false : (bool6 == 1 ? true : throwInvalidBool());
                break;
              }
              default: {
                throw new TypeError('invalid variant discriminant for option');
            ...
            switch (dataView(memory0).getUint8(base + 24, true)) {
              ...
              case 1: {
                variant8 = BigInt.asUintN(64, BigInt(dataView(memory0).getBigInt64(base + 32, true)));
                break;
              }
              default: {
                throw new TypeError('invalid variant discriminant for option');
            ...
            variant9 = {
              type: variant5,
              hasDynamicOffset: variant7,
              minBindingSize: variant8,
            };
            break;
          }
          default: {
        ...
        switch (dataView(memory0).getUint8(base + 40, true)) {
          ...
          case 1: {
            let variant11;
            switch (dataView(memory0).getUint8(base + 41, true)) {
              case 0: {
                variant11 = undefined;
                break;
              }
              case 1: {
                let enum10;
                switch (dataView(memory0).getUint8(base + 42, true)) {
                  case 0: {
                    enum10 = 'filtering';
                    break;
                  }
                  case 1: {
                    enum10 = 'non-filtering';
                    break;
                  }
                  case 2: {
                    enum10 = 'comparison';
                  ...
                  default: {
                    throw new TypeError('invalid discriminant specified for GpuSamplerBindingType');
                  }
                }
                variant11 = enum10;
                break;
        ...
        let variant19;
        switch (dataView(memory0).getUint8(base + 43, true)) {
          case 0: {
            variant19 = undefined;
            break;
          }
          case 1: {
            ...
            switch (dataView(memory0).getUint8(base + 44, true)) {
              ...
              case 1: {
                let enum13;
                switch (dataView(memory0).getUint8(base + 45, true)) {
                  case 0: {
                    enum13 = 'float';
                    break;
                  }
                  case 1: {
                    enum13 = 'unfilterable-float';
                    break;
                  }
                  case 2: {
                    enum13 = 'depth';
                  ...
                  default: {
                    throw new TypeError('invalid discriminant specified for GpuTextureSampleType');
                  }
                }
                variant14 = enum13;
                break;
            ...
            let variant16;
            switch (dataView(memory0).getUint8(base + 46, true)) {
              case 0: {
                variant16 = undefined;
                break;
              }
              case 1: {
                let enum15;
                switch (dataView(memory0).getUint8(base + 47, true)) {
                  case 0: {
                    enum15 = 'd1';
                    break;
                  }
            ...
            switch (dataView(memory0).getUint8(base + 48, true)) {
              ...
              case 1: {
                var bool17 = dataView(memory0).getUint8(base + 49, true);
                variant18 = bool17 == 0 ? false : (bool17 == 1 ? true : throwInvalidBool());
                break;
              }
              default: {
                throw new TypeError('invalid variant discriminant for option');
            ...
            variant19 = {
              sampleType: variant14,
              viewDimension: variant16,
              multisampled: variant18,
            };
            break;
          }
          default: {
        ...
        let variant25;
        switch (dataView(memory0).getUint8(base + 50, true)) {
          case 0: {
            variant25 = undefined;
            break;
          }
          case 1: {
            let variant21;
            switch (dataView(memory0).getUint8(base + 51, true)) {
              case 0: {
                variant21 = undefined;
                break;
              }
              case 1: {
                ...
                switch (dataView(memory0).getUint8(base + 52, true)) {
                  ...
                  default: {
                    throw new TypeError('invalid discriminant specified for GpuStorageTextureAccess');
                  }
                }
                variant21 = enum20;
                break;
            ...
            let enum22;
            switch (dataView(memory0).getUint8(base + 53, true)) {
              case 0: {
                enum22 = 'r8unorm';
                break;
              }
              ...
              case 48: {
                enum22 = 'depth32float-stencil8';
                break;
              }
              case 49: {
                enum22 = 'bc1-rgba-unorm';
                break;
              }
              case 50: {
                enum22 = 'bc1-rgba-unorm-srgb';
                break;
              }
              case 51: {
                enum22 = 'bc2-rgba-unorm';
                break;
              }
              case 52: {
                enum22 = 'bc2-rgba-unorm-srgb';
                break;
              }
              case 53: {
                enum22 = 'bc3-rgba-unorm';
                break;
              }
              case 54: {
                enum22 = 'bc3-rgba-unorm-srgb';
                break;
              }
              case 55: {
                enum22 = 'bc4-r-unorm';
              ...
              case 59: {
                enum22 = 'bc6h-rgb-ufloat';
                break;
              }
              case 60: {
                enum22 = 'bc6h-rgb-float';
                break;
              }
              case 61: {
                enum22 = 'bc7-rgba-unorm';
                break;
              }
              case 62: {
                enum22 = 'bc7-rgba-unorm-srgb';
                break;
              }
              case 63: {
                enum22 = 'etc2-rgb8unorm';
                break;
              }
              case 64: {
                enum22 = 'etc2-rgb8unorm-srgb';
                break;
              }
              case 65: {
                enum22 = 'etc2-rgb8a1unorm';
                break;
              }
              case 66: {
                enum22 = 'etc2-rgb8a1unorm-srgb';
                break;
              }
              case 67: {
                enum22 = 'etc2-rgba8unorm';
                break;
              }
              case 68: {
                enum22 = 'etc2-rgba8unorm-srgb';
                break;
              }
              case 69: {
                enum22 = 'eac-r11unorm';
              ...
              case 71: {
                enum22 = 'eac-rg11unorm';
                break;
              }
              case 72: {
                enum22 = 'eac-rg11snorm';
                break;
              }
              case 73: {
                enum22 = 'astc4x4-unorm';
                break;
              }
              case 74: {
                enum22 = 'astc4x4-unorm-srgb';
                break;
              }
              case 75: {
                enum22 = 'astc5x4-unorm';
                break;
              }
              case 76: {
                enum22 = 'astc5x4-unorm-srgb';
                break;
              }
              case 77: {
                enum22 = 'astc5x5-unorm';
                break;
              }
              case 78: {
                enum22 = 'astc5x5-unorm-srgb';
                break;
              }
              case 79: {
                enum22 = 'astc6x5-unorm';
                break;
              }
              case 80: {
                enum22 = 'astc6x5-unorm-srgb';
                break;
              }
              case 81: {
                enum22 = 'astc6x6-unorm';
                break;
              }
              case 82: {
                enum22 = 'astc6x6-unorm-srgb';
                break;
              }
              case 83: {
                enum22 = 'astc8x5-unorm';
                break;
              }
              case 84: {
                enum22 = 'astc8x5-unorm-srgb';
                break;
              }
              case 85: {
                enum22 = 'astc8x6-unorm';
                break;
              }
              case 86: {
                enum22 = 'astc8x6-unorm-srgb';
                break;
              }
              case 87: {
                enum22 = 'astc8x8-unorm';
                break;
              }
              case 88: {
                enum22 = 'astc8x8-unorm-srgb';
                break;
              }
              case 89: {
                enum22 = 'astc10x5-unorm';
                break;
              }
              case 90: {
                enum22 = 'astc10x5-unorm-srgb';
                break;
              }
              case 91: {
                enum22 = 'astc10x6-unorm';
                break;
              }
              case 92: {
                enum22 = 'astc10x6-unorm-srgb';
                break;
              }
              case 93: {
                enum22 = 'astc10x8-unorm';
                break;
              }
              case 94: {
                enum22 = 'astc10x8-unorm-srgb';
                break;
              }
              case 95: {
                enum22 = 'astc10x10-unorm';
                break;
              }
              case 96: {
                enum22 = 'astc10x10-unorm-srgb';
                break;
              }
              case 97: {
                enum22 = 'astc12x10-unorm';
                break;
              }
              case 98: {
                enum22 = 'astc12x10-unorm-srgb';
                break;
              }
              case 99: {
                enum22 = 'astc12x12-unorm';
                break;
              }
              case 100: {
                enum22 = 'astc12x12-unorm-srgb';
                break;
              }
              default: {
                throw new TypeError('invalid discriminant specified for GpuTextureFormat');
            ...
            let variant24;
            switch (dataView(memory0).getUint8(base + 54, true)) {
              case 0: {
                variant24 = undefined;
                break;
              }
              case 1: {
                let enum23;
                switch (dataView(memory0).getUint8(base + 55, true)) {
                  case 0: {
                    enum23 = 'd1';
                    break;
                  }
        ...
        result26.push({
          binding: dataView(memory0).getInt32(base + 0, true) >>> 0,
          visibility: flags3,
          buffer: variant9,
          sampler: variant12,
          texture: variant19,
          storageTexture: variant25,
        });
      }
      let variant28;
      switch (arg3) {
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-device.create-bind-group-layout"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      const createTask = () => {
        const results = createNewCurrentTask({
          componentIdx: -1,
          isAsync: false,
          entryFnName: 'createBindGroupLayout',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: false,
      ...
      if (!(ret instanceof GpuBindGroupLayout)) {
        throw new TypeError('Resource error: Not a valid \"GpuBindGroupLayout\" resource.');
      }
      var handle29 = ret[symbolRscHandle];
      if (!handle29) {
        const rep = ret[symbolRscRep] || ++captureCnt12;
        captureTable12.set(rep, ret);
        handle29 = rscTableCreateOwn(handleTable12, rep);
      }
      
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-device.create-bind-group-layout"][Instruction::Return]', {
        funcName: '[method]gpu-device.create-bind-group-layout',
        paramCount: 1,
        async: false,
        postReturn: false
      });
      task.resolve([handle29]);
      task.exit();
      return handle29;
    }
    _trampoline60.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#createBindGroupLayout';
    ...
    const _trampoline61 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
      var handle1 = arg0;
      ...
      if (!handle11) {
        ...
        handle11 = rscTableCreateOwn(handleTable13, rep);
      }
    ...
    _trampoline61.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#createPipelineLayout';
    ...
    const _trampoline62 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
      var handle1 = arg0;
      ...
      var len24 = arg3;
      var base24 = arg2;
      if (base24 % 8 !== 0) throw new TypeError(`list pointer [${base24}] is not aligned to 8`);
      var result24 = [];
      for (let i = 0; i < len24; i++) {
        const base = base24 + i * 56;
        let variant23;
        switch (dataView(memory0).getUint8(base + 8, true)) {
          case 0: {
            var handle7 = dataView(memory0).getInt32(base + 16, true);
            
            var rep8 = handleTable4[(handle7 << 1) + 1] & ~T_FLAG;
            var rsc6 = captureTable4.get(rep8);
            if (!rsc6) {
              rsc6 = Object.create(GpuBuffer.prototype);
              Object.defineProperty(rsc6, symbolRscHandle, { writable: true, value: handle7});
              Object.defineProperty(rsc6, symbolRscRep, { writable: true, value: rep8});
            }
          ...
          case 1: {
            var handle10 = dataView(memory0).getInt32(base + 16, true);
            
            var rep11 = handleTable4[(handle10 << 1) + 1] & ~T_FLAG;
            var rsc9 = captureTable4.get(rep11);
            if (!rsc9) {
              rsc9 = Object.create(GpuBuffer.prototype);
              Object.defineProperty(rsc9, symbolRscHandle, { writable: true, value: handle10});
              Object.defineProperty(rsc9, symbolRscRep, { writable: true, value: rep11});
            }
            
            curResourceBorrows.push(rsc9);
            let variant12;
            switch (dataView(memory0).getUint8(base + 24, true)) {
              case 0: {
                variant12 = undefined;
              ...
              case 1: {
                variant12 = BigInt.asUintN(64, BigInt(dataView(memory0).getBigInt64(base + 32, true)));
                break;
              }
              default: {
                throw new TypeError('invalid variant discriminant for option');
            ...
            switch (dataView(memory0).getUint8(base + 40, true)) {
              ...
              case 1: {
                variant13 = BigInt.asUintN(64, BigInt(dataView(memory0).getBigInt64(base + 48, true)));
                break;
              }
              default: {
                throw new TypeError('invalid variant discriminant for option');
          ...
          case 2: {
            var handle15 = dataView(memory0).getInt32(base + 16, true);
            
            var rep16 = handleTable14[(handle15 << 1) + 1] & ~T_FLAG;
            var rsc14 = captureTable14.get(rep16);
            if (!rsc14) {
              rsc14 = Object.create(GpuSampler.prototype);
              Object.defineProperty(rsc14, symbolRscHandle, { writable: true, value: handle15});
              Object.defineProperty(rsc14, symbolRscRep, { writable: true, value: rep16});
            }
            
            curResourceBorrows.push(rsc14);
            variant23= {
              tag: 'gpu-sampler',
              val: rsc14
            };
          ...
          case 3: {
            var handle18 = dataView(memory0).getInt32(base + 16, true);
            
            var rep19 = handleTable11[(handle18 << 1) + 1] & ~T_FLAG;
            var rsc17 = captureTable11.get(rep19);
            if (!rsc17) {
              rsc17 = Object.create(GpuTexture.prototype);
              Object.defineProperty(rsc17, symbolRscHandle, { writable: true, value: handle18});
              Object.defineProperty(rsc17, symbolRscRep, { writable: true, value: rep19});
            }
            
            curResourceBorrows.push(rsc17);
            variant23= {
              tag: 'gpu-texture',
              val: rsc17
            };
          ...
          case 4: {
            var handle21 = dataView(memory0).getInt32(base + 16, true);
            
            var rep22 = handleTable6[(handle21 << 1) + 1] & ~T_FLAG;
            var rsc20 = captureTable6.get(rep22);
            if (!rsc20) {
              rsc20 = Object.create(GpuTextureView.prototype);
              Object.defineProperty(rsc20, symbolRscHandle, { writable: true, value: handle21});
              Object.defineProperty(rsc20, symbolRscRep, { writable: true, value: rep22});
            }
            
            curResourceBorrows.push(rsc20);
            variant23= {
          ...
          default: {
            throw new TypeError('invalid variant discriminant for GpuBindingResource');
          }
        }
        result24.push({
          binding: dataView(memory0).getInt32(base + 0, true) >>> 0,
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-device.create-bind-group"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      if (!(ret instanceof GpuBindGroup)) {
        throw new TypeError('Resource error: Not a valid \"GpuBindGroup\" resource.');
      }
      var handle27 = ret[symbolRscHandle];
      if (!handle27) {
        const rep = ret[symbolRscRep] || ++captureCnt15;
        captureTable15.set(rep, ret);
        handle27 = rscTableCreateOwn(handleTable15, rep);
      }
      
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-device.create-bind-group"][Instruction::Return]', {
        funcName: '[method]gpu-device.create-bind-group',
        paramCount: 1,
        async: false,
        postReturn: false
      });
      task.resolve([handle27]);
      task.exit();
      return handle27;
    }
    _trampoline62.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#createBindGroup';
    ...
    const _trampoline63 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
      var handle1 = arg0;
              ...
              case 1: {
                ...
                switch (dataView(memory0).getUint8(base + 12, true)) {
                  case 0: {
                    ...
                    var rep7 = handleTable13[(handle6 << 1) + 1] & ~T_FLAG;
                    var rsc5 = captureTable13.get(rep7);
                    if (!rsc5) {
      ...
      if (!handle14) {
        ...
        handle14 = rscTableCreateOwn(handleTable16, rep);
      }
    ...
    _trampoline63.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#createShaderModule';
    ...
    const _trampoline64 = function(arg0) {
      var handle1 = dataView(memory0).getInt32(arg0 + 0, true);
      ...
      var rep12 = handleTable16[(handle11 << 1) + 1] & ~T_FLAG;
      var rsc10 = captureTable16.get(rep12);
      if (!rsc10) {
      ...
      switch (dataView(memory0).getUint8(arg0 + 32, true)) {
        ...
        case 1: {
          ...
          var rep17 = handleTable17[(handle16 << 1) + 1] & ~T_FLAG;
          var rsc15 = captureTable17.get(rep17);
          if (!rsc15) {
            ...
            captureTable17.delete(rep17);
          }
          rscTableRemove(handleTable17, handle16);
          variant18 = rsc15;
          break;
        }
        default: {
      ...
      switch (dataView(memory0).getUint8(arg0 + 144, true)) {
        ...
        case 1: {
          ...
          var rep84 = handleTable16[(handle83 << 1) + 1] & ~T_FLAG;
          var rsc82 = captureTable16.get(rep84);
          if (!rsc82) {
          ...
          switch (dataView(memory0).getUint8(arg0 + 172, true)) {
            ...
            case 1: {
              ...
              var rep89 = handleTable17[(handle88 << 1) + 1] & ~T_FLAG;
              var rsc87 = captureTable17.get(rep89);
              if (!rsc87) {
                ...
                captureTable17.delete(rep89);
              }
              rscTableRemove(handleTable17, handle88);
              variant90 = rsc87;
              break;
            }
            default: {
      ...
      switch (dataView(memory0).getUint8(arg0 + 180, true)) {
        case 0: {
          ...
          var rep94 = handleTable13[(handle93 << 1) + 1] & ~T_FLAG;
          var rsc92 = captureTable13.get(rep94);
          if (!rsc92) {
      ...
      if (!handle98) {
        ...
        handle98 = rscTableCreateOwn(handleTable18, rep);
      }
    ...
    _trampoline64.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#createRenderPipeline';
    ...
    _trampoline65.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#createCommandEncoder';
    ...
    const _trampoline66 = function(arg0, arg1, arg2) {
      ...
      for (let i = 0; i < len6; i++) {
        ...
        var rsc3 = captureTable9.get(rep5);
        if (!rsc3) {
    ...
    _trampoline66.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#submit';
    
    const _trampoline67 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
      var handle1 = arg0;
      ...
      switch (arg5) {
        ...
        case 1: {
          variant7 = BigInt.asUintN(64, BigInt(arg6));
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (arg7) {
        ...
        case 1: {
          variant8 = BigInt.asUintN(64, BigInt(arg8));
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-queue.write-buffer-with-copy"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      const createTask = () => {
        const results = createNewCurrentTask({
          componentIdx: -1,
          isAsync: false,
          entryFnName: 'writeBufferWithCopy',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'result-catch-handler',
          callingWasmExport: false,
      ...
      try {
        const hostRet9 = _withGlobalCurrentTaskMeta({
          componentIdx: task.componentIdx(),
          taskID: task.id(),
          fn: () => rsc0.writeBufferWithCopy(rsc3, BigInt.asUintN(64, BigInt(arg2)), result6, variant7, variant8),
        })
        ;
      ...
      switch (variant13.tag) {
        ...
        case 'err': {
          ...
          var {kind: v10_0, message: v10_1 } = e;
          var variant11 = v10_0;
          switch (variant11.tag) {
            ...
            default: {
              throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant11.tag)}\` (received \`${variant11}\`) specified for \`WriteBufferErrorKind\``);
            }
          }
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-queue.write-buffer-with-copy"][Instruction::Return]', {
        funcName: '[method]gpu-queue.write-buffer-with-copy',
        paramCount: 0,
        async: false,
        postReturn: false
      });
    ...
    _trampoline67.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#writeBufferWithCopy';
    
    const _trampoline68 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11) {
      var handle1 = arg0;
      ...
      switch (arg2) {
        ...
        case 1: {
          ...
          if (!rsc3) {
            rsc3 = Object.create(GpuBindGroup.prototype);
            Object.defineProperty(rsc3, symbolRscHandle, { writable: true, value: handle4});
            Object.defineProperty(rsc3, symbolRscRep, { writable: true, value: rep5});
          }
      ...
      switch (arg4) {
        ...
        case 1: {
          var ptr7 = arg5;
          var len7 = arg6;
          if (ptr7 % 4 !== 0) throw new TypeError(`list pointer [${ptr7}] is not aligned to 4`);
          var result7 = new Uint32Array(memory0.buffer.slice(ptr7, ptr7 + len7 * 4));
          variant8 = result7;
          break;
        }
        default: {
      ...
      switch (arg7) {
        ...
        case 1: {
          variant9 = BigInt.asUintN(64, BigInt(arg8));
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-render-pass-encoder.set-bind-group"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      let ret;
      try {
        const hostRet11 = _withGlobalCurrentTaskMeta({
          componentIdx: task.componentIdx(),
          taskID: task.id(),
          fn: () => rsc0.setBindGroup(arg1 >>> 0, variant6, variant8, variant9, variant10),
        })
        ;
        ret = hostRet11 !== null && typeof hostRet11 === 'object' && (hostRet11.tag === 'ok' || hostRet11.tag === 'err')
        ? hostRet11
        : { tag: 'ok', val: hostRet11};
      } catch (e) {
        if (getOrCreateAsyncState(0).markTrapped(e)) { throw e; }
        ret = { tag: 'err', val: getErrorPayload(e) };
      }
      ...
      switch (variant15.tag) {
        ...
        case 'err': {
          ...
          var {kind: v12_0, message: v12_1 } = e;
          var variant13 = v12_0;
          switch (variant13.tag) {
            case 'range-error': {
              dataView(memory0).setInt8(arg11 + 4, 0, true);
              break;
            }
            default: {
              throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant13.tag)}\` (received \`${variant13}\`) specified for \`SetBindGroupErrorKind\``);
            }
          }
          ...
          dataView(memory0).setUint32(arg11 + 12, len14, true);
          dataView(memory0).setUint32(arg11 + 8, ptr14, true);
      ...
      _debugLog('[iface="wasi:webgpu/webgpu@0.3.0-rc.2", function="[method]gpu-render-pass-encoder.set-bind-group"][Instruction::Return]', {
        funcName: '[method]gpu-render-pass-encoder.set-bind-group',
        paramCount: 0,
        async: false,
        postReturn: false
      });
    ...
    _trampoline68.fnName = 'wasi:webgpu/webgpu@0.3.0-rc.2#setBindGroup';
    ...
    const _trampoline69 = function(arg0) {
      ...
      if (!handle20) {
        ...
        handle20 = rscTableCreateOwn(handleTable6, rep);
      }
    ...
    _trampoline74.fnName = 'wasi-gfx:surface/surface-webgpu@0.2.0#configure';
    
    const _trampoline75 = function(arg0, arg1, arg2) {
      var ptr0 = arg0;
      var len0 = arg1;
      var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
      _debugLog('[iface="lagrange:assets/provider@0.1.0", function="load"] [Instruction::CallInterface] (sync, @ enter)');
      const hostProvided = true;
      ...
      _debugLog('[iface="lagrange:assets/provider@0.1.0", function="load"][Instruction::Return]', {
        funcName: 'load',
        paramCount: 0,
        async: false,
        postReturn: false
    ...
    _trampoline75.fnName = 'lagrange:assets/provider@0.1.0#load';
    ...
    _trampoline76.fnName = 'print#print';
    let exports2;
    let callback_0;
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 8),_liftFlatBorrow.bind(null, 18)],
      resultLowerFns: [],
      hasResultPointer: false,
      funcTypeIsAsync: false,
      getCallbackFn: () => null,
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 8),_liftFlatU32,
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatBorrow.bind(null, 4), 4, 4, 1, ['i32'] ],
        ],
        variantSize32: 8,
        variantAlign32: 4,
    ...
    function trampoline16(handle) {
      ...
      if (handleEntry.own) {
        ...
        } else if (GpuBindGroup[symbolCabiDispose]) {
          GpuBindGroup[symbolCabiDispose](handleEntry.rep);
        }
      }
    }
    function trampoline17(handle) {
      ...
      if (handleEntry.own) {
        ...
        } else if (GpuBuffer[symbolCabiDispose]) {
          GpuBuffer[symbolCabiDispose](handleEntry.rep);
        }
      }
    }
    ...
    null,
    {
      ...
      resultLowerFns: [_lowerFlatOwn({
        ...
        function lowerImportedOwnedHost_Surface(obj) {
          ...
          let handle = obj[symbolRscHandle];
          if (!handle) {
            const rep = obj[symbolRscRep] || ++captureCnt19;
            captureTable19.set(rep, obj);
            handle = rscTableCreateOwn(handleTable19, rep);
          }
          return handle;
        }
        ,
    ...
    null,
    {
      ...
      resultLowerFns: [_lowerFlatOwn({
        ...
        function lowerImportedOwnedHost_Context(obj) {
          ...
          let handle = obj[symbolRscHandle];
          if (!handle) {
            const rep = obj[symbolRscRep] || ++captureCnt20;
            captureTable20.set(rep, obj);
            handle = rscTableCreateOwn(handleTable20, rep);
          }
          return handle;
        }
        ,
    ...
    function trampoline26(handle) {
      ...
      if (handleEntry.own) {
        ...
        } else if (GpuBindGroupLayout[symbolCabiDispose]) {
          GpuBindGroupLayout[symbolCabiDispose](handleEntry.rep);
        }
      }
    }
    ...
    const trampoline30 = new WebAssembly.Suspending(_suspendingImport(0, subtaskCancel.bind(null, 0, false)));
    ...
    const trampoline37 = new WebAssembly.Suspending(_suspendingImport(0, streamCancelWrite.bind(null, {
      streamTableIdx: 0,
      isAsync: false,
      componentIdx: 0,
    })));
    ...
    const trampoline38 = new WebAssembly.Suspending(_suspendingImport(0, streamCancelRead.bind(null, {
      streamTableIdx: 0,
      isAsync: false,
      componentIdx: 0,
    })));
    
    const trampoline39 = streamDropWritable.bind(null, {
      streamTableIdx: 0,
      componentIdx: 0,
    });
    
    const trampoline40 = streamDropReadable.bind(null, {
      streamTableIdx: 0,
      componentIdx: 0,
    });
    
    const trampoline41 = streamNew.bind(null, {
      streamTableIdx: 0,
    ...
    const trampoline42 = new WebAssembly.Suspending(_suspendingImport(0, streamCancelWrite.bind(null, {
      streamTableIdx: 1,
      isAsync: false,
      componentIdx: 0,
    })));
    ...
    const trampoline43 = new WebAssembly.Suspending(_suspendingImport(0, streamCancelRead.bind(null, {
      streamTableIdx: 1,
      isAsync: false,
      componentIdx: 0,
    })));
    
    const trampoline44 = streamDropWritable.bind(null, {
      streamTableIdx: 1,
      componentIdx: 0,
    });
    
    const trampoline45 = streamDropReadable.bind(null, {
      streamTableIdx: 1,
      componentIdx: 0,
    });
    
    const trampoline46 = streamNew.bind(null, {
      streamTableIdx: 1,
      callerComponentIdx: 0,
      elemMeta: {
        liftFn: _liftFlatRecord({ fieldMetas: [['nothing', _liftFlatBool, 1, 1],], size32: 1, align32: 1 }),
    ...
    const trampoline47 = subtaskDrop.bind(
    null,
    0,
    );
    const trampoline48 = waitableSetDrop.bind(null, 0);
    
    const trampoline49 = waitableJoin.bind(null, 0);
    
    const trampoline50 = waitableSetNew.bind(null, 0);
    
    const trampoline51 = taskCancel.bind(null, 0);
    
    let trampoline52 = new WebAssembly.Suspending(_suspendingImport(0, _lowerImport.bind(
    null,
    {
      trampolineIdx: 52,
      componentIdx: 0,
    ...
    let trampoline53 = new WebAssembly.Suspending(_suspendingImport(0, _lowerImport.bind(
    null,
    {
      trampolineIdx: 53,
      componentIdx: 0,
    ...
    null,
    {
      ...
      _lowerFlatResult({
        ...
        [ 'ok', null, 16, 4, 4 ],
        [ 'err', _lowerFlatRecord({ fieldMetas: [['kind', _lowerFlatVariant({
          caseMetas: [[ 'abort-error', null, 0, 0, 0 ],],
          variantSize32: 1,
          variantAlign32: 1,
          variantPayloadOffset32: 1,
          variantFlatCount: 1,
    ...
    null,
    {
      ...
      _lowerFlatResult({
        ...
        [ 'ok', null, 16, 4, 4 ],
        [ 'err', _lowerFlatRecord({ fieldMetas: [['kind', _lowerFlatVariant({
          caseMetas: [[ 'operation-error', null, 0, 0, 0 ],[ 'range-error', null, 0, 0, 0 ],[ 'type-error', null, 0, 0, 0 ],],
          variantSize32: 1,
          variantAlign32: 1,
          variantPayloadOffset32: 1,
          variantFlatCount: 1,
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 5),_liftFlatRecord({ fieldMetas: [['colorAttachments', _liftFlatList({
        elemLiftFn: 
        _liftFlatOption({
          caseMetas: [
          ['none', null, 0, 0, 0, [] ],
          ['some', _liftFlatRecord({ fieldMetas: [['view', _liftFlatBorrow.bind(null, 6), 4, 4],['depthSlice', 
          _liftFlatOption({
            caseMetas: [
            ['none', null, 0, 0, 0, [] ],
            ['some', _liftFlatU32, 4, 4, 1, ['i32'] ],
      ...
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatRecord({ fieldMetas: [['view', _liftFlatBorrow.bind(null, 6), 4, 4],['depthClearValue', 
        _liftFlatOption({
          caseMetas: [
          ['none', null, 0, 0, 0, [] ],
      ...
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatBorrow.bind(null, 7), 4, 4, 1, ['i32'] ],
        ],
        variantSize32: 8,
        variantAlign32: 4,
        variantPayloadOffset32: 4,
      ...
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatRecord({ fieldMetas: [['querySet', _liftFlatBorrow.bind(null, 7), 4, 4],['beginningOfPassWriteIndex', 
        _liftFlatOption({
          caseMetas: [
          ['none', null, 0, 0, 0, [] ],
          ['some', _liftFlatU32, 4, 4, 1, ['i32'] ],
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatRecord({ fieldMetas: [['size', _liftFlatU64, 8, 8],['usage', _liftFlatFlags({ names: ['mapRead','mapWrite','copySrc','copyDst','index','vertex','uniform','storage','indirect','queryResolve'], size32: 2, align32: 2, intSizeBytes: 2 }), 2, 2],['mappedAtCreation', 
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatBool, 1, 1, 1, ['i32'] ],
      ...
      , 12, 4],], size32: 24, align32: 8 })],
      resultLowerFns: [_lowerFlatOwn({
        componentIdx: 0,
        lowerFn: 
        function lowerImportedOwnedHost_GpuBuffer(obj) {
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatRecord({ fieldMetas: [['size', _liftFlatRecord({ fieldMetas: [['width', _liftFlatU32, 4, 4],['height', 
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatU32, 4, 4, 1, ['i32'] ],
      ...
      , 8, 4],], size32: 20, align32: 4 }), 20, 4],['mipLevelCount', 
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatU32, 4, 4, 1, ['i32'] ],
      ...
      _liftFlatOption({
        ...
        ['some', 
        _liftFlatEnum({
          caseMetas: [['d1', null, 1, 1, 1],['d2', null, 1, 1, 1],['d3', null, 1, 1, 1],],
          variantSize32: 1,
          variantAlign32: 1,
          variantPayloadOffset32: 1,
          variantFlatCount: 1,
      ...
      , 1, 1],['usage', _liftFlatFlags({ names: ['copySrc','copyDst','textureBinding','storageBinding','renderAttachment','transientAttachment'], size32: 1, align32: 1, intSizeBytes: 1 }), 1, 1],['viewFormats', 
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatList({
      ...
      , 12, 4],['textureBindingViewDimension', 
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', 
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatRecord({ fieldMetas: [['entries', _liftFlatList({
        elemLiftFn: _liftFlatRecord({ fieldMetas: [['binding', _liftFlatU32, 4, 4],['visibility', _liftFlatFlags({ names: ['vertex','fragment','compute'], size32: 1, align32: 1, intSizeBytes: 1 }), 1, 1],['buffer', 
        _liftFlatOption({
          caseMetas: [
          ['none', null, 0, 0, 0, [] ],
          ['some', _liftFlatRecord({ fieldMetas: [['type', 
          _liftFlatOption({
            caseMetas: [
            ['none', null, 0, 0, 0, [] ],
            ['some', 
            _liftFlatEnum({
              caseMetas: [['uniform', null, 1, 1, 1],['storage', null, 1, 1, 1],['read-only-storage', null, 1, 1, 1],],
              variantSize32: 1,
              variantAlign32: 1,
              variantPayloadOffset32: 1,
              variantFlatCount: 1,
          ...
          , 16, 8],], size32: 24, align32: 8 }), 24, 8, 6, ['i32','i32','i32','i32','i32','i64'] ],
          ],
          variantSize32: 32,
          variantAlign32: 8,
          variantPayloadOffset32: 8,
          variantFlatCount: 7,
          variantPayloadFlatTypes: ['i32','i32','i32','i32','i32','i64'],
        })
        , 32, 8],['sampler', 
        _liftFlatOption({
          caseMetas: [
          ...
          _liftFlatOption({
            ...
            ['some', 
            _liftFlatEnum({
              caseMetas: [['filtering', null, 1, 1, 1],['non-filtering', null, 1, 1, 1],['comparison', null, 1, 1, 1],],
              variantSize32: 1,
              variantAlign32: 1,
              variantPayloadOffset32: 1,
              variantFlatCount: 1,
        ...
        _liftFlatOption({
          caseMetas: [
          ['none', null, 0, 0, 0, [] ],
          ['some', _liftFlatRecord({ fieldMetas: [['sampleType', 
          _liftFlatOption({
            caseMetas: [
            ['none', null, 0, 0, 0, [] ],
            ['some', 
            _liftFlatEnum({
              caseMetas: [['float', null, 1, 1, 1],['unfilterable-float', null, 1, 1, 1],['depth', null, 1, 1, 1],['sint', null, 1, 1, 1],['uint', null, 1, 1, 1],],
              variantSize32: 1,
              variantAlign32: 1,
              variantPayloadOffset32: 1,
              variantFlatCount: 1,
          ...
          , 2, 1],], size32: 6, align32: 1 }), 6, 1, 6, ['i32','i32','i32','i32','i32','i32'] ],
          ],
          variantSize32: 7,
          variantAlign32: 1,
          variantPayloadOffset32: 1,
        ...
        _liftFlatOption({
          caseMetas: [
          ['none', null, 0, 0, 0, [] ],
          ['some', _liftFlatRecord({ fieldMetas: [['access', 
          _liftFlatOption({
            caseMetas: [
            ['none', null, 0, 0, 0, [] ],
            ['some', 
            _liftFlatEnum({
              caseMetas: [['write-only', null, 1, 1, 1],['read-only', null, 1, 1, 1],['read-write', null, 1, 1, 1],],
              variantSize32: 1,
              variantAlign32: 1,
              variantPayloadOffset32: 1,
              variantFlatCount: 1,
          ...
          , 2, 1],], size32: 5, align32: 1 }), 5, 1, 5, ['i32','i32','i32','i32','i32'] ],
          ],
          variantSize32: 6,
          variantAlign32: 1,
          variantPayloadOffset32: 1,
      ...
      resultLowerFns: [_lowerFlatOwn({
        componentIdx: 0,
        lowerFn: 
        function lowerImportedOwnedHost_GpuBindGroupLayout(obj) {
          if (!(obj instanceof GpuBindGroupLayout)) {
            throw new TypeError('Resource error: Not a valid \"GpuBindGroupLayout\" resource.');
          }
          let handle = obj[symbolRscHandle];
          if (!handle) {
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatRecord({ fieldMetas: [['bindGroupLayouts', _liftFlatList({
        ...
        _liftFlatOption({
          caseMetas: [
          ['none', null, 0, 0, 0, [] ],
          ['some', _liftFlatBorrow.bind(null, 12), 4, 4, 1, ['i32'] ],
          ],
          variantSize32: 8,
          variantAlign32: 4,
          variantPayloadOffset32: 4,
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 3),_liftFlatRecord({ fieldMetas: [['layout', _liftFlatBorrow.bind(null, 12), 4, 4],['entries', _liftFlatList({
        elemLiftFn: _liftFlatRecord({ fieldMetas: [['binding', _liftFlatU32, 4, 4],['resource', _liftFlatVariant({
          caseMetas: [['gpu-buffer', _liftFlatBorrow.bind(null, 4), 4, 4, 1, ['i32']],['gpu-buffer-binding', _liftFlatRecord({ fieldMetas: [['buffer', _liftFlatBorrow.bind(null, 4), 4, 4],['offset', 
          _liftFlatOption({
            caseMetas: [
            ['none', null, 0, 0, 0, [] ],
            ['some', _liftFlatU64, 8, 8, 1, ['i64'] ],
          ...
          , 16, 8],], size32: 40, align32: 8 }), 40, 8, 5, ['i32','i32','i64','i32','i64']],['gpu-sampler', _liftFlatBorrow.bind(null, 14), 4, 4, 1, ['i32']],['gpu-texture', _liftFlatBorrow.bind(null, 11), 4, 4, 1, ['i32']],['gpu-texture-view', _liftFlatBorrow.bind(null, 6), 4, 4, 1, ['i32']],],
          variantSize32: 48,
          variantAlign32: 8,
          variantPayloadOffset32: 8,
          variantFlatCount: 6,
          variantPayloadFlatTypes: ['i32','i32','i64','i32','i64'],
        } ), 48, 8],], size32: 56, align32: 8 }),
        elemAlign32: 8,
        elemSize32: 56,
        typedArray: undefined,
      }), 8, 4],['label', 
      ...
      , 12, 4],], size32: 24, align32: 4 })],
      resultLowerFns: [_lowerFlatOwn({
        componentIdx: 0,
        lowerFn: 
        function lowerImportedOwnedHost_GpuBindGroup(obj) {
          if (!(obj instanceof GpuBindGroup)) {
            throw new TypeError('Resource error: Not a valid \"GpuBindGroup\" resource.');
          }
          let handle = obj[symbolRscHandle];
          if (!handle) {
        ...
        ['some', _liftFlatList({
          ...
          _liftFlatOption({
            ...
            ['some', _liftFlatVariant({
              caseMetas: [['specific', _liftFlatBorrow.bind(null, 13), 4, 4, 1, ['i32']],['auto', null, 0, 0, 0, []],],
              variantSize32: 8,
              variantAlign32: 4,
              variantPayloadOffset32: 4,
              variantFlatCount: 2,
    ...
    null,
    {
      ...
      , 12, 4],['module', _liftFlatBorrow.bind(null, 16), 4, 4],['entryPoint', 
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatStringAny, 8, 4, 2, ['i32','i32'] ],
      ...
      _liftFlatOption({
        ...
        ['some', _liftFlatRecord({ fieldMetas: [['targets', _liftFlatList({
          ...
          elemSize32: 17,
          typedArray: undefined,
        }), 8, 4],['module', _liftFlatBorrow.bind(null, 16), 4, 4],['entryPoint', 
        _liftFlatOption({
          caseMetas: [
          ['none', null, 0, 0, 0, [] ],
          ['some', _liftFlatStringAny, 8, 4, 2, ['i32','i32'] ],
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 10),_liftFlatList({
        elemLiftFn: _liftFlatBorrow.bind(null, 9),
        elemAlign32: 4,
        elemSize32: 4,
        typedArray: undefined,
      })],
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 10),_liftFlatBorrow.bind(null, 4),_liftFlatU64,_liftFlatList({
        elemLiftFn: _liftFlatU8,
        elemAlign32: 1,
        elemSize32: 1,
        typedArray: Uint8Array,
      ...
      _lowerFlatResult({
        ...
        [ 'ok', null, 16, 4, 4 ],
        [ 'err', _lowerFlatRecord({ fieldMetas: [['kind', _lowerFlatVariant({
          caseMetas: [[ 'operation-error', null, 0, 0, 0 ],],
          variantSize32: 1,
          variantAlign32: 1,
          variantPayloadOffset32: 1,
          variantFlatCount: 1,
    ...
    null,
    {
      ...
      _liftFlatOption({
        caseMetas: [
        ['none', null, 0, 0, 0, [] ],
        ['some', _liftFlatBorrow.bind(null, 15), 4, 4, 1, ['i32'] ],
        ],
        variantSize32: 8,
        variantAlign32: 4,
        variantPayloadOffset32: 4,
      ...
      _lowerFlatResult({
        ...
        [ 'ok', null, 16, 4, 4 ],
        [ 'err', _lowerFlatRecord({ fieldMetas: [['kind', _lowerFlatVariant({
          caseMetas: [[ 'range-error', null, 0, 0, 0 ],],
          variantSize32: 1,
          variantAlign32: 1,
          variantPayloadOffset32: 1,
          variantFlatCount: 1,
    ...
    null,
    {
      ...
      paramLiftFns: [_liftFlatBorrow.bind(null, 20),_liftFlatRecord({ fieldMetas: [['device', _liftFlatBorrow.bind(null, 3), 4, 4],['format', 
      _liftFlatEnum({
        caseMetas: [['r8unorm', null, 1, 1, 1],['r8snorm', null, 1, 1, 1],['r8uint', null, 1, 1, 1],['r8sint', null, 1, 1, 1],['r16unorm', null, 1, 1, 1],['r16snorm', null, 1, 1, 1],['r16uint', null, 1, 1, 1],['r16sint', null, 1, 1, 1],['r16float', null, 1, 1, 1],['rg8unorm', null, 1, 1, 1],['rg8snorm', null, 1, 1, 1],['rg8uint', null, 1, 1, 1],['rg8sint', null, 1, 1, 1],['r32uint', null, 1, 1, 1],['r32sint', null, 1, 1, 1],['r32float', null, 1, 1, 1],['rg16unorm', null, 1, 1, 1],['rg16snorm', null, 1, 1, 1],['rg16uint', null, 1, 1, 1],['rg16sint', null, 1, 1, 1],['rg16float', null, 1, 1, 1],['rgba8unorm', null, 1, 1, 1],['rgba8unorm-srgb', null, 1, 1, 1],['rgba8snorm', null, 1, 1, 1],['rgba8uint', null, 1, 1, 1],['rgba8sint', null, 1, 1, 1],['bgra8unorm', null, 1, 1, 1],['bgra8unorm-srgb', null, 1, 1, 1],['rgb9e5ufloat', null, 1, 1, 1],['rgb10a2uint', null, 1, 1, 1],['rgb10a2unorm', null, 1, 1, 1],['rg11b10ufloat', null, 1, 1, 1],['rg32uint', null, 1, 1, 1],['rg32sint', null, 1, 1, 1],['rg32float', null, 1, 1, 1],['rgba16unorm', null, 1, 1, 1],['rgba16snorm', null, 1, 1, 1],['rgba16uint', null, 1, 1, 1],['rgba16sint', null, 1, 1, 1],['rgba16float', null, 1, 1, 1],['rgba32uint', null, 1, 1, 1],['rgba32sint', null, 1, 1, 1],['rgba32float', null, 1, 1, 1],['stencil8', null, 1, 1, 1],['depth16unorm', null, 1, 1, 1],['depth24plus', null, 1, 1, 1],['depth24plus-stencil8', null, 1, 1, 1],['depth32float', null, 1, 1, 1],['depth32float-stencil8', null, 1, 1, 1],['bc1-rgba-unorm', null, 1, 1, 1],['bc1-rgba-unorm-srgb', null, 1, 1, 1],['bc2-rgba-unorm', null, 1, 1, 1],['bc2-rgba-unorm-srgb', null, 1, 1, 1],['bc3-rgba-unorm', null, 1, 1, 1],['bc3-rgba-unorm-srgb', null, 1, 1, 1],['bc4-r-unorm', null, 1, 1, 1],['bc4-r-snorm', null, 1, 1, 1],['bc5-rg-unorm', null, 1, 1, 1],['bc5-rg-snorm', null, 1, 1, 1],['bc6h-rgb-ufloat', null, 1, 1, 1],['bc6h-rgb-float', null, 1, 1, 1],['bc7-rgba-unorm', null, 1, 1, 1],['bc7-rgba-unorm-srgb', null, 1, 1, 1],['etc2-rgb8unorm', null, 1, 1, 1],['etc2-rgb8unorm-srgb', null, 1, 1, 1],['etc2-rgb8a1unorm', null, 1, 1, 1],['etc2-rgb8a1unorm-srgb', null, 1, 1, 1],['etc2-rgba8unorm', null, 1, 1, 1],['etc2-rgba8unorm-srgb', null, 1, 1, 1],['eac-r11unorm', null, 1, 1, 1],['eac-r11snorm', null, 1, 1, 1],['eac-rg11unorm', null, 1, 1, 1],['eac-rg11snorm', null, 1, 1, 1],['astc4x4-unorm', null, 1, 1, 1],['astc4x4-unorm-srgb', null, 1, 1, 1],['astc5x4-unorm', null, 1, 1, 1],['astc5x4-unorm-srgb', null, 1, 1, 1],['astc5x5-unorm', null, 1, 1, 1],['astc5x5-unorm-srgb', null, 1, 1, 1],['astc6x5-unorm', null, 1, 1, 1],['astc6x5-unorm-srgb', null, 1, 1, 1],['astc6x6-unorm', null, 1, 1, 1],['astc6x6-unorm-srgb', null, 1, 1, 1],['astc8x5-unorm', null, 1, 1, 1],['astc8x5-unorm-srgb', null, 1, 1, 1],['astc8x6-unorm', null, 1, 1, 1],['astc8x6-unorm-srgb', null, 1, 1, 1],['astc8x8-unorm', null, 1, 1, 1],['astc8x8-unorm-srgb', null, 1, 1, 1],['astc10x5-unorm', null, 1, 1, 1],['astc10x5-unorm-srgb', null, 1, 1, 1],['astc10x6-unorm', null, 1, 1, 1],['astc10x6-unorm-srgb', null, 1, 1, 1],['astc10x8-unorm', null, 1, 1, 1],['astc10x8-unorm-srgb', null, 1, 1, 1],['astc10x10-unorm', null, 1, 1, 1],['astc10x10-unorm-srgb', null, 1, 1, 1],['astc12x10-unorm', null, 1, 1, 1],['astc12x10-unorm-srgb', null, 1, 1, 1],['astc12x12-unorm', null, 1, 1, 1],['astc12x12-unorm-srgb', null, 1, 1, 1],],
        variantSize32: 1,
        variantAlign32: 1,
    ...
    const trampoline77 = waitableSetPoll.bind(
    null,
    {
      componentIdx: 0,
      isAsync: false,
    ...
    try {
      ...
      ({ exports: exports1 } = yield instantiateCore(yield module0, {
        $root: {
          ...
          '[subtask-cancel]': trampoline30,
          '[subtask-drop]': _guardMayLeave(0, trampoline47),
          '[waitable-join]': _guardMayLeave(0, trampoline49),
          '[waitable-set-drop]': _guardMayLeave(0, trampoline48),
          '[waitable-set-new]': _guardMayLeave(0, trampoline50),
          '[waitable-set-poll]': exports0['25'],
          print: exports0['24'],
        },
        '[export]$root': {
          '[task-cancel]': _guardMayLeave(0, trampoline51),
          '[task-return]start': _guardMayLeave(0, trampoline29),
        },
        'lagrange:assets/provider@0.1.0': {
          load: exports0['23'],
        },
        'wasi-gfx:surface/surface-webgpu@0.2.0': {
          '[constructor]context': trampoline20,
          '[method]context.configure': exports0['22'],
          '[method]context.get-current-texture': trampoline31,
          '[method]context.present': trampoline35,
          '[resource-drop]context': _guardMayLeave(0, trampoline14),
        },
        'wasi-gfx:surface/surface@0.2.0': {
          '[async-lower][stream-read-0][method]surface.on-frame': exports0['21'],
          '[async-lower][stream-read-0][method]surface.on-resize': exports0['19'],
          '[async-lower][stream-write-0][method]surface.on-frame': exports0['20'],
          '[async-lower][stream-write-0][method]surface.on-resize': exports0['18'],
          '[constructor]surface': trampoline19,
          '[method]surface.height': trampoline22,
          '[method]surface.on-frame': trampoline27,
          '[method]surface.on-resize': trampoline28,
          '[method]surface.width': trampoline21,
          '[resource-drop]surface': _guardMayLeave(0, trampoline13),
          '[stream-cancel-read-0][method]surface.on-frame': trampoline43,
          '[stream-cancel-read-0][method]surface.on-resize': trampoline38,
          '[stream-cancel-write-0][method]surface.on-frame': trampoline42,
          '[stream-cancel-write-0][method]surface.on-resize': trampoline37,
          '[stream-drop-readable-0][method]surface.on-frame': _guardMayLeave(0, trampoline45),
          '[stream-drop-readable-0][method]surface.on-resize': _guardMayLeave(0, trampoline40),
          '[stream-drop-writable-0][method]surface.on-frame': _guardMayLeave(0, trampoline44),
          '[stream-drop-writable-0][method]surface.on-resize': _guardMayLeave(0, trampoline39),
          '[stream-new-0][method]surface.on-frame': _guardMayLeave(0, trampoline46),
          '[stream-new-0][method]surface.on-resize': _guardMayLeave(0, trampoline41),
        },
        'wasi:webgpu/webgpu@0.3.0-rc.2': {
          ...
          '[method]gpu-buffer.get-mapped-range-set-with-copy': exports0['3'],
          '[method]gpu-buffer.unmap': exports0['2'],
          '[method]gpu-command-encoder.begin-render-pass': exports0['4'],
          '[method]gpu-command-encoder.finish': exports0['5'],
          '[method]gpu-device.create-bind-group': exports0['10'],
          '[method]gpu-device.create-bind-group-layout': exports0['8'],
          '[method]gpu-device.create-buffer': exports0['6'],
          '[method]gpu-device.create-command-encoder': exports0['13'],
          '[method]gpu-device.create-pipeline-layout': exports0['9'],
          '[method]gpu-device.create-render-pipeline': exports0['12'],
          '[method]gpu-device.create-shader-module': exports0['11'],
          '[method]gpu-device.create-texture': exports0['7'],
          '[method]gpu-device.queue': trampoline2,
          '[method]gpu-queue.submit': exports0['14'],
          '[method]gpu-queue.write-buffer-with-copy': exports0['15'],
          '[method]gpu-render-pass-encoder.draw-indexed': trampoline8,
          '[method]gpu-render-pass-encoder.end': trampoline4,
          '[method]gpu-render-pass-encoder.set-bind-group': exports0['16'],
          '[method]gpu-render-pass-encoder.set-index-buffer': trampoline6,
          '[method]gpu-render-pass-encoder.set-pipeline': trampoline5,
          '[method]gpu-render-pass-encoder.set-vertex-buffer': trampoline7,
          '[method]gpu-texture.create-view': exports0['17'],
          '[method]gpu.get-preferred-canvas-format': trampoline0,
          '[resource-drop]gpu': _guardMayLeave(0, trampoline11),
          '[resource-drop]gpu-adapter': _guardMayLeave(0, trampoline10),
          '[resource-drop]gpu-bind-group': _guardMayLeave(0, trampoline16),
          '[resource-drop]gpu-bind-group-layout': _guardMayLeave(0, trampoline26),
          '[resource-drop]gpu-buffer': _guardMayLeave(0, trampoline17),
          '[resource-drop]gpu-command-buffer': _guardMayLeave(0, trampoline34),
          '[resource-drop]gpu-command-encoder': _guardMayLeave(0, trampoline36),
          '[resource-drop]gpu-device': _guardMayLeave(0, trampoline12),
          '[resource-drop]gpu-pipeline-layout': _guardMayLeave(0, trampoline25),
          '[resource-drop]gpu-queue': _guardMayLeave(0, trampoline32),
          '[resource-drop]gpu-render-pass-encoder': _guardMayLeave(0, trampoline33),
          '[resource-drop]gpu-render-pipeline': _guardMayLeave(0, trampoline15),
          '[resource-drop]gpu-shader-module': _guardMayLeave(0, trampoline24),
          '[resource-drop]gpu-texture': _guardMayLeave(0, trampoline23),
          '[resource-drop]gpu-texture-view': _guardMayLeave(0, trampoline18),
      ...
      ({ exports: exports2 } = yield instantiateCore(yield module2, {
        '': {
          ...
          '23': trampoline75,
          '24': trampoline76,
          '25': _guardMayLeave(0, trampoline77),
          '3': trampoline55,
          '4': trampoline56,
          '5': trampoline57,
          '6': trampoline58,
