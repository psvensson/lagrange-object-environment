"use components";
import { loadGlb } from '../../../../src/browser-renderer/assets.js';
...
class StreamWritableEnd extends StreamEnd {
  ...
  const _trampoline75 = function(arg0, arg1, arg2) {
    ...
    _debugLog('[iface="lagrange:assets/provider@0.1.0", function="load-glb"] [Instruction::CallInterface] (sync, @ enter)');
    const hostProvided = true;
    ...
    _debugLog('[iface="lagrange:assets/provider@0.1.0", function="load-glb"][Instruction::Return]', {
      funcName: 'load-glb',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  _trampoline75.fnName = 'lagrange:assets/provider@0.1.0#loadGlb';
  ...
  const $init = (() => {
    let gen = (function* _initGenerator () {
      const module0 = fetchCompile(new URL('./glb.component.core.wasm', import.meta.url));
      const module1 = base64Compile('');
      const module2 = base64Compile('');
